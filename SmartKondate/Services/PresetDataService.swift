...
struct PresetDataService {
    ...
    private static func insertJapanseHome(context: ModelContext) {
        ...
        func getOrCreateMenu(name: String, category: MenuCategory, source: String? = nil) -> Menu {
        ...
        let rawIngredients: [RawIngredient] = [
            ...
            RawIngredient(menuName: "鮭とキノコのクリーム煮", name: "牛乳", quantity: 280, unit: "g", source: "うたまる親子 p.55"),
            RawIngredient(menuName: "チキンソテー（トマト）", name: "鶏もも肉", quantity: 300, unit: "g", source: "ハツ江おばあちゃん p.26＆33"),
            RawIngredient(menuName: "チキンソテー（トマト）", name: "トマト缶", quantity: 0.5, unit: "パック", source: "ハツ江おばあちゃん p.26＆33"),
            RawIngredient(menuName: "チキンソテー（トマト）", name: "玉ねぎ", quantity: 0.25, unit: "個", source: "ハツ江おばあちゃん p.26＆33"),
            RawIngredient(menuName: "麻婆豆腐", name: "合いびき肉", quantity: 300, unit: "g", source: "うたまる親子 p.85"),
            RawIngredient(menuName: "麻婆豆腐", name: "長ネギ", quantity: 0.5, unit: "本", source: "うたまる親子 p.85"),
            RawIngredient(menuName: "麻婆豆腐", name: "豆腐", quantity: 300, unit: "g", source: "うたまる親子 p.85"),
            RawIngredient(menuName: "豚肉トマト煮込み", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "ヘルシオ p.9"),
            RawIngredient(menuName: "豚肉トマト煮込み", name: "豚ロース肉", quantity: 200, unit: "g", source: "ヘルシオ p.9"),
            RawIngredient(menuName: "豚肉トマト煮込み", name: "トマト缶", quantity: 0.5, unit: "パック", source: "ヘルシオ p.9"),
            RawIngredient(menuName: "照り焼きチキン", name: "鶏もも肉", quantity: 500, unit: "g", source: "うたまる親子 p.40"),
            RawIngredient(menuName: "豚肉とトマト重ね蒸し", name: "豚ロース肉", quantity: 200, unit: "g", source: "ハツ江おばあちゃん p.14"),
            RawIngredient(menuName: "豚肉とトマト重ね蒸し", name: "トマト", quantity: 2, unit: "個", source: "ハツ江おばあちゃん p.14"),
            RawIngredient(menuName: "豚肉とトマト重ね蒸し", name: "えのき", quantity: 1, unit: "パック", source: "ハツ江おばあちゃん p.14"),
            RawIngredient(menuName: "豚肉とトマト重ね蒸し", name: "青じそ", quantity: 10, unit: "枚", source: "ハツ江おばあちゃん p.14"),
            RawIngredient(menuName: "簡単トマト煮込みハンバーグ", name: "合いびき肉", quantity: 320, unit: "g", source: "うたまる親子 p.25"),
            RawIngredient(menuName: "簡単トマト煮込みハンバーグ", name: "玉ねぎ", quantity: 1, unit: "個", source: "うたまる親子 p.25"),
            RawIngredient(menuName: "簡単トマト煮込みハンバーグ", name: "しめじ", quantity: 0.5, unit: "パック", source: "うたまる親子 p.25"),
            RawIngredient(menuName: "簡単トマト煮込みハンバーグ", name: "トマト缶", quantity: 0.5, unit: "パック", source: "うたまる親子 p.25"),
            RawIngredient(menuName: "簡単トマト煮込みハンバーグ", name: "卵", quantity: 1, unit: "個", source: "うたまる親子 p.25"),
            RawIngredient(menuName: "豚生姜焼き（さくなし）", name: "豚こま肉", quantity: 200, unit: "g", source: "The基本 p.11"),
            RawIngredient(menuName: "野菜たっぷりカレーライス", name: "豚こま肉", quantity: 200, unit: "g", source: "うたまる親子 p.89"),
            RawIngredient(menuName: "野菜たっぷりカレーライス", name: "玉ねぎ", quantity: 1, unit: "個", source: "うたまる親子 p.89"),
            RawIngredient(menuName: "野菜たっぷりカレーライス", name: "にんじん", quantity: 1, unit: "本", source: "うたまる親子 p.89"),
            RawIngredient(menuName: "野菜たっぷりカレーライス", name: "じゃがいも", quantity: 2, unit: "個", source: "うたまる親子 p.89"),
            RawIngredient(menuName: "野菜たっぷりカレーライス", name: "カレールー", quantity: 80, unit: "g", source: "うたまる親子 p.89"),
            RawIngredient(menuName: "野菜たっぷりカレーライス", name: "トマト缶", quantity: 1, unit: "パック", source: "うたまる親子 p.89"),
            RawIngredient(menuName: "大葉とチーズのミルフィーユカツ", name: "豚ロース肉", quantity: 250, unit: "g", source: "おぼん献立 p. 24"),
            RawIngredient(menuName: "大葉とチーズのミルフィーユカツ", name: "スライスチーズ", quantity: 4, unit: "枚", source: "おぼん献立 p. 24"),
            RawIngredient(menuName: "大葉とチーズのミルフィーユカツ", name: "青じそ", quantity: 4, unit: "枚", source: "おぼん献立 p. 24"),
            RawIngredient(menuName: "鶏の唐揚げ", name: "鶏もも肉(切)", quantity: 400, unit: "g", source: "うたまる親子 p.37"),
            RawIngredient(menuName: "ユーリンチー", name: "鶏もも肉", quantity: 300, unit: "g", source: "https://www.yutori.co.jp/shop/rp/rp201604/?srsltid=AU7gw4XBNxF3J0UgtD2-OrwJB-Wn3Y3Upgoput9blyr_ttgBxYC4lXPs"),
            RawIngredient(menuName: "ユーリンチー", name: "長ネギ", quantity: 0.25, unit: "本", source: "https://www.yutori.co.jp/shop/rp/rp201604/?srsltid=AU7gw4XBNxF3J0UgtD2-OrwJB-Wn3Y3Upgoput9blyr_ttgBxYC4lXPs"),
            RawIngredient(menuName: "ぶりの照り焼き", name: "ぶり", quantity: 3, unit: "切", source: "うたまる親子 p.60"),
            RawIngredient(menuName: "豆腐入り月見つくね", name: "鶏ひき肉", quantity: 200, unit: "g", source: "おぼん献立 p. 66"),
            RawIngredient(menuName: "豆腐入り月見つくね", name: "豆腐", quantity: 75, unit: "g", source: "おぼん献立 p. 66"),
            RawIngredient(menuName: "豆腐入り月見つくね", name: "卵", quantity: 3, unit: "個", source: "おぼん献立 p. 66"),
            RawIngredient(menuName: "肉じゃが", name: "牛薄切り肉", quantity: 150, unit: "g", source: "うたまる親子 p.52"),
            RawIngredient(menuName: "肉じゃが", name: "玉ねぎ", quantity: 1, unit: "個", source: "うたまる親子 p.52"),
            RawIngredient(menuName: "肉じゃが", name: "じゃがいも", quantity: 4, unit: "個", source: "うたまる親子 p.52"),
            RawIngredient(menuName: "肉じゃが", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.52"),
            RawIngredient(menuName: "たらのムニエル", name: "たら", quantity: 3, unit: "切", source: "うたまる親子 p.59"),
            RawIngredient(menuName: "プルコギ", name: "牛薄切り肉", quantity: 300, unit: "g", source: "うたまる親子 p.51"),
            RawIngredient(menuName: "プルコギ", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "うたまる親子 p.51"),
            RawIngredient(menuName: "プルコギ", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.51"),
            RawIngredient(menuName: "プルコギ", name: "ニラ", quantity: 0.5, unit: "束", source: "うたまる親子 p.51"),
            RawIngredient(menuName: "ローストビーフ", name: "牛もも肉（塊）", quantity: 300, unit: "g", source: "https://cookpad.com/jp/recipes/18575949"),
            RawIngredient(menuName: "ステーキ", name: "牛ステーキ肉", quantity: 300, unit: "g", source: "https://delishkitchen.tv/recipes/201097815550592081"),
            RawIngredient(menuName: "メンチカツ", name: "合いびき肉", quantity: 250, unit: "g", source: "ハツ江おばあちゃん p.101"),
            RawIngredient(menuName: "メンチカツ", name: "玉ねぎ", quantity: 0.25, unit: "個", source: "ハツ江おばあちゃん p.101"),
            RawIngredient(menuName: "メンチカツ", name: "卵", quantity: 1, unit: "個", source: "ハツ江おばあちゃん p.101"),
            RawIngredient(menuName: "スペアリブの煮込み", name: "スペアリブ肉", quantity: 400, unit: "g", source: "ヘルシオ p.9"),
            RawIngredient(menuName: "スペアリブの煮込み", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "ヘルシオ p.9"),
            RawIngredient(menuName: "豚の角煮", name: "豚肩ロース（塊）", quantity: 800, unit: "g", source: "ヘルシオ p.8"),
            RawIngredient(menuName: "豚の角煮", name: "ネギの青い部分", quantity: 1, unit: "本", source: "ヘルシオ p.8"),
            RawIngredient(menuName: "餃子", name: "冷凍餃子", quantity: 1, unit: "袋", source: nil),
            RawIngredient(menuName: "スコップコロッケ", name: "合いびき肉", quantity: 200, unit: "g", source: "うたまる親子 p.30"),
            RawIngredient(menuName: "スコップコロッケ", name: "じゃがいも", quantity: 4, unit: "個", source: "うたまる親子 p.30"),
            RawIngredient(menuName: "スコップコロッケ", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "うたまる親子 p.30"),
            RawIngredient(menuName: "ひじきの煮物", name: "芽ひじき", quantity: 11, unit: "g", source: "うたまる親子 p.133"),
            RawIngredient(menuName: "ひじきの煮物", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.133"),
            RawIngredient(menuName: "ひじきの煮物", name: "ちくわ", quantity: 1, unit: "本", source: "うたまる親子 p.133"),
            RawIngredient(menuName: "アンチョビキャベツ", name: "キャペツ", quantity: 0.25, unit: "個", source: "ハツ江おばあちゃん p.54"),
            RawIngredient(menuName: "アンチョビキャベツ", name: "アンチョビ", quantity: 3, unit: "枚", source: "ハツ江おばあちゃん p.54"),
            RawIngredient(menuName: "トマトサラダ", name: "トマト", quantity: 1, unit: "個", source: "おぼん献立 p. 74"),
            RawIngredient(menuName: "トマトサラダ", name: "玉ねぎ", quantity: 0.25, unit: "個", source: "おぼん献立 p. 74"),
            RawIngredient(menuName: "ほうれん草としらすのおひたし", name: "ほうれん草", quantity: 1, unit: "束", source: "うたまる親子 p.128"),
            RawIngredient(menuName: "ほうれん草としらすのおひたし", name: "しらす", quantity: 20, unit: "g", source: "うたまる親子 p.128"),
            RawIngredient(menuName: "にんじんしりしり", name: "にんじん", quantity: 1, unit: "本", source: "うたまる親子 p.124"),
            RawIngredient(menuName: "にんじんしりしり", name: "ツナ", quantity: 1, unit: "缶", source: "うたまる親子 p.124"),
            RawIngredient(menuName: "なす味噌炒め", name: "なす", quantity: 5, unit: "個", source: "The基本 p.112"),
            RawIngredient(menuName: "きんぴらごぼう", name: "ごぼう", quantity: 1, unit: "本", source: "うたまる親子 p.134"),
            RawIngredient(menuName: "きんぴらごぼう", name: "にんじん", quantity: 1, unit: "本", source: "うたまる親子 p.134"),
            RawIngredient(menuName: "かぼちゃの煮物", name: "かぼちゃ", quantity: 0.25, unit: "個", source: "うたまる親子 p.122"),
            RawIngredient(menuName: "エビサラダ", name: "レタス", quantity: 0.25, unit: "個", source: "The基本 p.118"),
            RawIngredient(menuName: "エビサラダ", name: "冷凍エビ", quantity: 0.25, unit: "袋", source: "The基本 p.118"),
            RawIngredient(menuName: "切り干し大根の煮物", name: "切り干し大根", quantity: 35, unit: "g", source: "うたまる親子 p.129"),
            RawIngredient(menuName: "切り干し大根の煮物", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.129"),
            RawIngredient(menuName: "切り干し大根の煮物", name: "ちくわ", quantity: 2, unit: "本", source: "うたまる親子 p.129"),
            RawIngredient(menuName: "ブロッコリーとしらすのおかか和え", name: "ブロッコリー", quantity: 1, unit: "個", source: "うたまる親子 p.132"),
            RawIngredient(menuName: "ブロッコリーとしらすのおかか和え", name: "しらす", quantity: 20, unit: "g", source: "うたまる親子 p.132"),
            RawIngredient(menuName: "カプレーゼ", name: "トマト", quantity: 1, unit: "個", source: nil),
            RawIngredient(menuName: "カプレーゼ", name: "モッツァレラ", quantity: 1, unit: "個", source: nil),
            RawIngredient(menuName: "焼きびたし", name: "なす", quantity: 3, unit: "個", source: "うたまる親子 p.130"),
            RawIngredient(menuName: "ほうれん草とにんじんのナムル", name: "ほうれん草", quantity: 1, unit: "束", source: "うたまる親子 p.124"),
            RawIngredient(menuName: "ほうれん草とにんじんのナムル", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.124"),
            RawIngredient(menuName: "豆苗とツナの和風炒め", name: "豆苗", quantity: 1, unit: "袋", source: "うたまる親子 p.118"),
            RawIngredient(menuName: "豆苗とツナの和風炒め", name: "ツナ", quantity: 1, unit: "缶", source: "うたまる親子 p.118"),
            RawIngredient(menuName: "アンチョビブロッコリー", name: "ブロッコリー", quantity: 1, unit: "個", source: "ハツ江おばあちゃん p.54"),
            RawIngredient(menuName: "アンチョビブロッコリー", name: "アンチョビ", quantity: 3, unit: "枚", source: "ハツ江おばあちゃん p.54"),
            RawIngredient(menuName: "レタスオイスター炒め", name: "レタス", quantity: 0.25, unit: "個", source: "The基本 p.115"),
            RawIngredient(menuName: "牛すじの煮込み", name: "牛すじ", quantity: 500, unit: "g", source: "ヘルシオ p.10"),
            RawIngredient(menuName: "牛すじの煮込み", name: "こんにゃく", quantity: 1, unit: "枚", source: "ヘルシオ p.10"),
            RawIngredient(menuName: "牛すじの煮込み", name: "ネギの青い部分", quantity: 1, unit: "本", source: "ヘルシオ p.10"),
            RawIngredient(menuName: "トマト卵炒め", name: "トマト", quantity: 1, unit: "個", source: "https://www.nichireifoods.co.jp/media/9561/"),
            RawIngredient(menuName: "トマト卵炒め", name: "卵", quantity: 2, unit: "個", source: "https://www.nichireifoods.co.jp/media/9561/"),
            RawIngredient(menuName: "鶏と大根の煮物", name: "鶏もも肉(切)", quantity: 120, unit: "g", source: "ヘルシオ p.7"),
            RawIngredient(menuName: "鶏と大根の煮物", name: "大根", quantity: 250, unit: "g", source: "ヘルシオ p.7"),
            RawIngredient(menuName: "和風しいたけマヨ", name: "しいたけ", quantity: 1, unit: "袋", source: "うたまる親子 p.134"),
            RawIngredient(menuName: "トマトのマリネサラダ", name: "トマト", quantity: 2, unit: "個", source: "うたまる親子 p.131"),
            RawIngredient(menuName: "オムライス", name: "鶏もも肉(切)", quantity: 80, unit: "g", source: "うたまる親子 p.73"),
            RawIngredient(menuName: "オムライス", name: "玉ねぎ", quantity: 0.25, unit: "個", source: "うたまる親子 p.73"),
            RawIngredient(menuName: "オムライス", name: "にんじん", quantity: 0.2, unit: "本", source: "うたまる親子 p.73"),
            RawIngredient(menuName: "オムライス", name: "卵", quantity: 5, unit: "個", source: "うたまる親子 p.73"),
            RawIngredient(menuName: "ポークケチャップ", name: "豚こま肉", quantity: 200, unit: "g", source: "おぼん献立 p. 101"),
            RawIngredient(menuName: "ポークケチャップ", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "おぼん献立 p. 101"),
            RawIngredient(menuName: "ミートソースパスタ", name: "合いびき肉", quantity: 250, unit: "g", source: "うたまる親子 p.94"),
            RawIngredient(menuName: "ミートソースパスタ", name: "玉ねぎ", quantity: 1, unit: "個", source: "うたまる親子 p.94"),
            RawIngredient(menuName: "ミートソースパスタ", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.94"),
            RawIngredient(menuName: "ミートソースパスタ", name: "スパゲッティ", quantity: 300, unit: "g", source: "うたまる親子 p.94"),
            RawIngredient(menuName: "ミートソースパスタ", name: "トマト缶", quantity: 0.5, unit: "パック", source: "うたまる親子 p.94"),
            RawIngredient(menuName: "チヂミ", name: "ニラ", quantity: 1, unit: "束", source: "ハツ江おばあちゃん p.41"),
            RawIngredient(menuName: "チヂミ", name: "豚バラ肉", quantity: 100, unit: "g", source: "ハツ江おばあちゃん p.41"),
            RawIngredient(menuName: "チヂミ", name: "キムチ", quantity: 1, unit: "袋", source: "ハツ江おばあちゃん p.41"),
            RawIngredient(menuName: "カオマンガイ", name: "鶏もも肉", quantity: 500, unit: "g", source: "うたまる親子 p.89"),
            RawIngredient(menuName: "カオマンガイ", name: "長ネギ", quantity: 0.5, unit: "本", source: "うたまる親子 p.89"),
            RawIngredient(menuName: "ささみユッケ丼", name: "ささみ", quantity: 6, unit: "本", source: "おぼん献立 p. 97"),
            RawIngredient(menuName: "ささみユッケ丼", name: "卵", quantity: 2, unit: "個", source: "おぼん献立 p. 97"),
            RawIngredient(menuName: "ツナトマトパスタ", name: "スパゲッティ", quantity: 300, unit: "g", source: "うたまる親子 p.100"),
            RawIngredient(menuName: "ツナトマトパスタ", name: "ツナ", quantity: 1, unit: "缶", source: "うたまる親子 p.100"),
            RawIngredient(menuName: "ツナトマトパスタ", name: "トマト缶", quantity: 0.5, unit: "パック", source: "うたまる親子 p.100"),
            RawIngredient(menuName: "お好み焼き", name: "お好み焼き粉", quantity: 100, unit: "g", source: "ハツ江おばあちゃん p.40"),
            RawIngredient(menuName: "お好み焼き", name: "キャペツ", quantity: 0.25, unit: "個", source: "ハツ江おばあちゃん p.40"),
            RawIngredient(menuName: "お好み焼き", name: "豚バラ肉", quantity: 100, unit: "g", source: "ハツ江おばあちゃん p.40"),
            RawIngredient(menuName: "お好み焼き", name: "冷凍エビ", quantity: 0.25, unit: "袋", source: "ハツ江おばあちゃん p.40"),
            RawIngredient(menuName: "親子丼", name: "鶏もも肉(切)", quantity: 240, unit: "g", source: "うたまる親子 p.77"),
            RawIngredient(menuName: "親子丼", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "うたまる親子 p.77"),
            RawIngredient(menuName: "親子丼", name: "卵", quantity: 2, unit: "個", source: "うたまる親子 p.77"),
            RawIngredient(menuName: "炒飯", name: "卵", quantity: 1, unit: "個", source: "The基本 p.64"),
            RawIngredient(menuName: "炒飯", name: "ハム", quantity: 70, unit: "g", source: "The基本 p.64"),
            RawIngredient(menuName: "炒飯", name: "長ネギ", quantity: 0.5, unit: "本", source: "The基本 p.64"),
            RawIngredient(menuName: "ガパオライス", name: "鶏ひき肉", quantity: 300, unit: "g", source: "うたまる親子 p.83"),
            RawIngredient(menuName: "ガパオライス", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "うたまる親子 p.83"),
            RawIngredient(menuName: "ガパオライス", name: "ピーマン", quantity: 1, unit: "個", source: "うたまる親子 p.83"),
            RawIngredient(menuName: "ガパオライス", name: "卵", quantity: 3, unit: "個", source: "うたまる親子 p.83"),
            RawIngredient(menuName: "リゾット", name: "トマト缶", quantity: 0.5, unit: "パック", source: "ヘルシオ p.38"),
            RawIngredient(menuName: "リゾット", name: "玉ねぎ", quantity: 0.25, unit: "個", source: "ヘルシオ p.38"),
            RawIngredient(menuName: "リゾット", name: "しめじ", quantity: 1, unit: "パック", source: "ヘルシオ p.38"),
            RawIngredient(menuName: "リゾット", name: "ベーコン", quantity: 1, unit: "袋", source: "ヘルシオ p.38"),
            RawIngredient(menuName: "ビビンバ", name: "合いびき肉", quantity: 250, unit: "g", source: "うたまる親子 p.81"),
            RawIngredient(menuName: "ビビンバ", name: "ほうれん草", quantity: 1, unit: "束", source: "うたまる親子 p.81"),
            RawIngredient(menuName: "ビビンバ", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.81"),
            RawIngredient(menuName: "ビビンバ", name: "もやし", quantity: 1, unit: "袋", source: "うたまる親子 p.81"),
            RawIngredient(menuName: "よだれどり", name: "鶏むね肉", quantity: 400, unit: "g", source: "おぼん献立 p. 69"),
            RawIngredient(menuName: "よだれどり", name: "長ネギ", quantity: 0.25, unit: "本", source: "おぼん献立 p. 69"),
            RawIngredient(menuName: "マカロニグラタン", name: "マカロニ", quantity: 100, unit: "g", source: "うたまる親子 p.101"),
            RawIngredient(menuName: "マカロニグラタン", name: "鶏もも肉", quantity: 125, unit: "g", source: "うたまる親子 p.101"),
            RawIngredient(menuName: "マカロニグラタン", name: "玉ねぎ", quantity: 1, unit: "個", source: "うたまる親子 p.101"),
            RawIngredient(menuName: "マカロニグラタン", name: "牛乳", quantity: 400, unit: "g", source: "うたまる親子 p.101"),
            RawIngredient(menuName: "きのこの和風パスタ", name: "スパゲッティ", quantity: 280, unit: "g", source: "うたまる親子 p.96"),
            RawIngredient(menuName: "きのこの和風パスタ", name: "しめじ", quantity: 1, unit: "パック", source: "うたまる親子 p.96"),
            RawIngredient(menuName: "きのこの和風パスタ", name: "ツナ", quantity: 2, unit: "缶", source: "うたまる親子 p.96"),
            RawIngredient(menuName: "塩焼きそば", name: "焼きそば麺", quantity: 3, unit: "袋", source: "うたまる親子 p.107"),
            RawIngredient(menuName: "塩焼きそば", name: "豚ロース肉", quantity: 100, unit: "g", source: "うたまる親子 p.107"),
            RawIngredient(menuName: "塩焼きそば", name: "キャペツ", quantity: 0.1, unit: "個", source: "うたまる親子 p.107"),
            RawIngredient(menuName: "塩焼きそば", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.107"),
            RawIngredient(menuName: "ポトフ", name: "白菜", quantity: 0.25, unit: "個", source: "https://esse-online.jp/articles/-/34980"),
            RawIngredient(menuName: "ポトフ", name: "じゃがいも", quantity: 2, unit: "個", source: "https://esse-online.jp/articles/-/34980"),
            RawIngredient(menuName: "ポトフ", name: "ソーセージ", quantity: 8, unit: "本", source: "https://esse-online.jp/articles/-/34980"),
            RawIngredient(menuName: "ラザニエッテ", name: "合いびき肉", quantity: 200, unit: "g", source: nil),
            RawIngredient(menuName: "鮭とかぼちゃのグラタン", name: "生鮭", quantity: 2, unit: "切", source: "おぼん献立 p. 86"),
            RawIngredient(menuName: "鮭とかぼちゃのグラタン", name: "かぼちゃ", quantity: 0.25, unit: "個", source: "おぼん献立 p. 86"),
            RawIngredient(menuName: "鮭とかぼちゃのグラタン", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "おぼん献立 p. 86"),
            RawIngredient(menuName: "鮭とかぼちゃのグラタン", name: "牛乳", quantity: 300, unit: "g", source: "おぼん献立 p. 86"),
            RawIngredient(menuName: "かぼちゃのポタージュ", name: "牛乳", quantity: 300, unit: "g", source: "Auto p.7"),
            RawIngredient(menuName: "かぼちゃのポタージュ", name: "玉ねぎ", quantity: 0.25, unit: "個", source: "Auto p.7"),
            RawIngredient(menuName: "かぼちゃのポタージュ", name: "かぼちゃ", quantity: 0.25, unit: "個", source: "Auto p.7"),
            RawIngredient(menuName: "じゃがいものポタージュ", name: "牛乳", quantity: 400, unit: "g", source: "毎日食べたい p.16"),
            RawIngredient(menuName: "じゃがいものポタージュ", name: "長ネギ", quantity: 0.5, unit: "本", source: "毎日食べたい p.16"),
            RawIngredient(menuName: "じゃがいものポタージュ", name: "じゃがいも", quantity: 1, unit: "個", source: "毎日食べたい p.16"),
            RawIngredient(menuName: "ほうれん草のすまし汁", name: "ほうれん草", quantity: 0.5, unit: "束", source: "うたまる親子 p.141"),
            RawIngredient(menuName: "ほうれん草のすまし汁", name: "しめじ", quantity: 0.5, unit: "パック", source: "うたまる親子 p.141"),
            RawIngredient(menuName: "にんじんのポタージュ", name: "玉ねぎ", quantity: 0.25, unit: "個", source: "毎日食べたい p.14"),
            RawIngredient(menuName: "にんじんのポタージュ", name: "にんじん", quantity: 1, unit: "本", source: "毎日食べたい p.14"),
            RawIngredient(menuName: "さつまいもの味噌汁", name: "さつまいも", quantity: 0.5, unit: "個", source: "うたまる親子 p.142"),
            RawIngredient(menuName: "さつまいもの味噌汁", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "うたまる親子 p.142"),
            RawIngredient(menuName: "さつまいもの味噌汁", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.142"),
            RawIngredient(menuName: "ミネストローネ", name: "玉ねぎ", quantity: 0.5, unit: "個", source: "うたまる親子 p.136"),
            RawIngredient(menuName: "ミネストローネ", name: "にんじん", quantity: 0.5, unit: "本", source: "うたまる親子 p.136"),
            RawIngredient(menuName: "ミネストローネ", name: "じゃがいも", quantity: 1, unit: "個", source: "うたまる親子 p.136"),
            RawIngredient(menuName: "ミネストローネ", name: "トマト缶", quantity: 1, unit: "パック", source: "うたまる親子 p.136"),
            RawIngredient(menuName: "豆腐とわかめの味噌汁", name: "豆腐", quantity: 150, unit: "g", source: "うたまる親子 p.142"),
            RawIngredient(menuName: "豆腐とわかめの味噌汁", name: "わかめ", quantity: 1, unit: "g", source: "うたまる親子 p.142"),
            RawIngredient(menuName: "トマトと卵のスープ", name: "トマト", quantity: 1, unit: "個", source: "うたまる親子 p.136"),
            RawIngredient(menuName: "トマトと卵のスープ", name: "卵", quantity: 2, unit: "個", source: "うたまる親子 p.136"),
            RawIngredient(menuName: "コーンポタージュ", name: "牛乳", quantity: 200, unit: "ml", source: "Auto p.8"),
            RawIngredient(menuName: "コーンポタージュ", name: "コーンパック", quantity: 1, unit: "個", source: "Auto p.8")
        ]
        ...
        for rawIng in rawIngredients {
            ...
            if let existing = menuCache.values.first(where: { $0.name == rawIng.menuName }) {
                ...
                targetMenu = getOrCreateMenu(name: rawIng.menuName, category: .main, source: rawIng.source)
            }

            if targetMenu.source.isEmpty, let source = rawIng.source {
